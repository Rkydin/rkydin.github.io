...
category: "Misc"
skills: ["3D Printing", "Prototyping", "SolidWorks"]
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 30px 0;">
  <div>
    <img src="/images/misc/fumehood_front.png" alt="Fumehood front view" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.3);">
    <p style="text-align: center; margin-top: 10px; font-size: 0.9em; color: #999;"><em>Fumehood front view</em></p>
  </div>
  <div>
    <img src="/images/misc/fumehood_attached.png" alt="Fumehood attached" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.3);">
...
<div style="margin: 30px 0;">
  <img src="/images/misc/window_vent.png" alt="Window vent" style="width: 100%; max-width: 600px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.3);">
